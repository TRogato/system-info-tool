...
function Export-SystemInfoToCSV {
    ...
    try {
        ...
        # SOFTWARE
        $csvData += [PSCustomObject]@{ Categoria = "SOFTWARE"; Campo = "MICROSOFT OFFICE"; Valor = Clean-SpecialCharacters $SystemData.OFFICEKEY }
...
Write-Field "Microsoft Office"   $OFFICEKEY
